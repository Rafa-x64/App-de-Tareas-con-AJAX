...
trait notificacionTrait
{
    ...
    public static function notificacion($titulo, $mensaje, $tipo)
    {
        ...
        <div class="container-fluid d-flex flex-column justify-content-start align-items-center px-2">
            <div class="col-6 d-flex flex-column justify-content-center align-items-start bg-light bg-opacity-75 p-4 border-1 border-white rounded shadow" style="backdrop-filter: blur(3px);>
