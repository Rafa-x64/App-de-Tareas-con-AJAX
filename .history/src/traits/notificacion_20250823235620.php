...
trait notificacionTrait
{
    ...
    {
        return '
        <div class="container-fluid d-flex flex-column justify-content-start align-items-center bg-light bg-opacity-75 p-4 border-1 border-white rounded shadow px-2">
