        ...
        <div class="col-6 bg-light bg-opacity-75 p-4 border-1 border-white rounded shadow" id="formulario_inicio_sesion_fondo">
            ...
            <form action="" method="post" class="form-control bg-transparent border-0" id="formulario_inicio_sesion">
                <div class="row d-flex flex-row justify-content-center align-items-end">
                    <div class="col-11">
                        <input type="text" name="" id="" class="form-control bg-transparent h-80 px-0" placeholder="Email">
                    </div>
                    <div class="col-1 formulario_inicio_sesion_icono px-0">
                        <i class="bi bi-envelope fs-4"></i>
                    </div>
                </div>
                <div class="row d-flex flex-row justify-content-center align-items-end">
                    <div class="col-11">
                        <input type="password" name="" id="" class="form-control bg-transparent h-80 mt-3 px-0" placeholder="Contraseña">
                    </div>
                    <div class="col-1 formulario_inicio_sesion_icono px-0">
