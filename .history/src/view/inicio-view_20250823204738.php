<section class="container-fluid mt-5">
    <div class="row d-flex flex-colum justify-content-center align-items-center">
        <div class="col-6 bg-light bg-opacity-75 p-4 border-1 border-white rounded shadow" id="formulario_inicio_sesion_fondo">
            ...
            <form action="" method="post" class="form-control bg-transparent border-0" id="formulario_inicio">
                <input type="text" name="" id="" class="form-control bg-transparent border-0 border-bottom h-80" placeholder="Email">
                <input type="password" name="" id="" class="form-control bg-transparent border-0 border-bottom h-80 mt-3" placeholder="Contraseña">
            </form>
        </div>
    </div>
</section>
