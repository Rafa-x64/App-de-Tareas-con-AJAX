<section class="container-fluid mt-5">
    <div class="row d-flex flex-colum justify-content-center align-items-center">
        ...
        <div class="col-6 bg-light bg-opacity-75 p-4 border-1 border-white rounded shadow" id="formulario_registro_fondo">
            ...
            <!--formulario-->
            <form action="" method="post" class="form-control bg-transparent border-0" id="formulario_registro">
                <!--nombre y apellido-->
                <div class="row d-flex flex-row justify-content-between align-items-center">
                    <div class="col-6 d-flex flex-row justify-content-center align-items-end">
                        <div class="col-11 px-0">
                            <input type="text" name="" id="" class="form-control bg-transparent fw-medium h-80 mt-4" placeholder="Nombre">
                        </div>
                    ...
                    <div class="col-6 d-flex flex-row justify-content-center align-items-end">
                        <div class="col-11 px-0">
                            <input type="text" name="" id="" class="form-control bg-transparent fw-medium h-80 mt-4" placeholder="Apellido">
                        </div>
                        <div class="col-1 d-flex flex-row justify-content-center formulario_registro_icono">
                            <i class="bi bi-person-badge fs-4"></i>
                        </div>
