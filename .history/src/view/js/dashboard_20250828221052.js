document.addEventListener("DOMContentLoaded", () => {
    ...
    formulario.addEventListener("submit", async (e) => { //pasamos el evento como parametro 
        ...
        try {
            //hacemos await para que la pagina espere mientras se hace el fetch (se envia el json)
            const respuesta = await fetch("php/controller/tarea_controller.php", { //ruta donde se va a enviar el json
                method: "POST",
                body: datos
            });
