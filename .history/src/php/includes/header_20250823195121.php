    ...
    <div class="row d-flex flex-row justify-content-center">
        ...
        <div class="col-6 d-flex justify-content-between align-items-center py-2">
            <ul class="list-group list-group-horizontal w-100 m-0 p-0">
                <li class="list-group-item bg-transparent border-0 border-0 flex-fill text-center">
                ...
                <li class="list-group-item border-0 flex-fill text-center">
                    <a href="" class="btn border-success border-2">
                        <h4 class="text-success mb-1">Iniciar Sesion</h4>
                    </a>
                </li>
            </ul>
        </div>
