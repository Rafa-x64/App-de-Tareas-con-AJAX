...
class tarea_model extends main_model
{
    ...
    public static function guardarTarea($nombre, $descripcion, $id)
    {
        ...
        return $stmt->execute([$nombre, $descripcion, $id]);//retornar esto es obligatorio
    }
    ...
    {
        $conexion = main_model::conectarBD();
        if (!$conexion) return ["ok" => false, "mensaje" => "No se pudo conectar a la base de datos"];
