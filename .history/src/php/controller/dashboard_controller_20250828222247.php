...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($nombre === "" || $descripcion === "") {
        //cuando se hace un envio al server (php) este deve devolver una respuesta en formato json para que pueda ser procesaod por el metodo .response de js (en dashboard.js)
        echo json_encode([
            "ok" => false,
