...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    foreach ($tareas as $tarea) {
        $html .=
            "<tr>
                <td class='d-flex flex-row justify-content-center align-it'>{$tarea['nombre']}</td>
                <td class='d-flex flex-row justify-content-center align-it'>{$tarea['descripcion']}</td>
                <td class='d-flex flex-row justify-content-center align-it'>
